...
int count=1;
while(count<=10){ //while(count<=10 && count%2==0)
  print(count);
  count++;
}
...
if(name==username &&mypassword==password){
...
if(validCredentials){
  ...
  loginAttempts++;
   print('Invalid credentials. Please try again.You have only $loginAttempts remain.');
}
