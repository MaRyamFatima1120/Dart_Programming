void main(){
  ...
  // do-while loop is a 
  // that executes a block of code once before checking the loop condition. It guarantees that the loop body is executed at least once, even if the condition is initially false. After executing the code block, the loop condition is evaluated, and if it's true, the loop continues executing. If the condition is false, the loop terminates.
